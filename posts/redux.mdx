...
Redux sirve para gestionar el estado de nuestra aplicación, facilita la administración del estado global mediante un almacenamiento centralizado. ¿Cuándo lo usaría? Lo usaría cuando la información se necesita en toda nuestra aplicación. Si la información solo se necesita en una página, podemos usar context. Si es solo entre componentes, RxJS.
...
Por cómo te lo voy a presentar, parece no tener sentido, pero de a poco empieza a cerrar
...
Con este provider vamos a envolver nuestra app

...
Además, envolvemos nuestras rutas en el componente Suspense, el cual nos permite mostrar un componente de carga (como un spinner) mientras se carga el componente diferido. En este caso, hemos utilizado <Spinner /> como ejemplo, pero puedes reemplazarlo con el componente de carga de tu elección.
